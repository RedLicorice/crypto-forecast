...
def build_model(dataset, pipeline, experiment, cv=5, scoring='f1', n_jobs='auto', test_size=0.3):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scoring',dest='scoring', nargs='?', default='roc_auc', help="Scorer to use for cross-validation in GridSearchCV")
    ...
    if args.pipeline == '':
        ...
        exit(0)
    build_model(args.dataset, args.pipeline, args.experiment, cv=args.cv, scoring=args.scoring, n_jobs=args.n_jobs, test_size=args.test_size)
