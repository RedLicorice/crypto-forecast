...
symbols = {
    ...
    'USDT_ETH': ['data/coinmetrics.io/usdt_eth.csv'],
    'VET': ['data/coinmetrics.io/vet.csv'],
...
for sym, csv in symbols.items():
    ...
    if check_duplicates(df):
        print('There are duplicates in csv for symbol: ' + sym)
        continue
...
result.to_csv('data/result/socials.csv', sep=',', encoding='utf-8', index=True, index_label='Date')